...
func _on_play_button_pressed() -> void: # takes you to choosing item screen
	SoundEffects.play_button_sound()
	TransitionScreen.transition()
	await TransitionScreen.on_transition_finished
	get_tree().change_scene_to_file("res://main game screens/choose_item_screen.tscn")

func _on_settings_button_pressed() -> void: # takes you to settings screen
	SoundEffects.play_button_sound()
	TransitionScreen.transition()
	await TransitionScreen.on_transition_finished
	get_tree().change_scene_to_file("res://opening screen/settings_screen.tscn")

func _on_load_button_pressed() -> void: # takes you to the load screen
	SoundEffects.play_button_sound()
	TransitionScreen.transition()
	await TransitionScreen.on_transition_finished
	get_tree().change_scene_to_file("res://opening screen/load_screen.tscn")

func _on_help_button_pressed() -> void: # takes you to the help screen
	SoundEffects.play_button_sound()
	TransitionScreen.transition()
	await TransitionScreen.on_transition_finished
	get_tree().change_scene_to_file("res://opening screen/help_screen.tscn")

func _on_quit_button_pressed() -> void: # takes you to the quitting game screen
	SoundEffects.play_button_sound()
	TransitionScreen.transition()
	await TransitionScreen.on_transition_finished
